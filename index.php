...
//        $pageArray= explode('.svg" /></div></div></div>', $forecastPage);
//        
//            
//                $secondPageArray= explode(' See the links',$pageArray[2]); 
//        
//               
...
//                  
        ...
        $pageArray= explode('<span class="b-forecast__table-description-title">', $forecastPage);
